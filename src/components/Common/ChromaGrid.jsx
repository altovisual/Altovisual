                    ...
                    <div className="chroma-modal-content glass" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="chroma-modal-body">
                            <div className="chroma-modal-profile">
                                <ProfileCard
                                    avatarUrl={selectedItem.image}
                                    name={selectedItem.title}
                                    title={selectedItem.subtitle}
                                    handle={selectedItem.handle || selectedItem.title.toLowerCase().replace(' ', '')}
                                    innerGradient={selectedItem.gradient}
                                    showUserInfo={true}
                                    enableMobileTilt={true}
                                />
                            </div>
                            <div className="chroma-modal-info">
                                <span className="modal-label" style={{ color: selectedItem.borderColor }}>{selectedItem.subtitle}</span>
